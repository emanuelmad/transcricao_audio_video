...
def transcreve_tab_audio():
    ...
    arquivo_audio = st.file_uploader('Adicione um arquivo de áudio', type=['mp3'])
...
# MAIN ================================
def main():
    st.header('Bem-vindo ao EAS Transcript 🎙️', divider=True)
    st.markdown('#### Transcreva áudio do microfone, vídeo e arquivos de áudio')
